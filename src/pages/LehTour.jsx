...
import golden_triangle from '../images/799_20231020080014_img_20231020075946_leh-ladakh-tour-package.jpg';
// import PackagesCard from '../common/PackagesCard'

export default function LehTour() {
  return (
    <>
    <Header/>
        ...
        <div className="container px-0">
            <div className="nav_listing">
                <ul className='d-flex list-inline'>
                    ...
                    <li className='fw-bold px-1'> / Leh</li>
                </ul>
            </div>
            <div className="row">
                <div>
                    <h1>Leh Tour Packages</h1>
                    <p>Leh Tour Packages</p>
                </div>
            </div>
