...
export default function BandhavgarhTour() {
  return (
    <>
    <Header/>
        ...
        <div className="container px-0">
            <div className="nav_listing">
                <ul className='d-flex list-inline'>
                    ...
                    <li className='fw-bold px-1'> / Bandhavgarh National Park</li>
                </ul>
            </div>
            <div className="row">
                <div>
                    <h1>Bandhavgarh National Park Tour Packages</h1>
                    <p>Bandhavgarh National Park Tour Packages</p>
                </div>
            </div>
