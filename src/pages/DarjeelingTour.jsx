...
import golden_triangle from '../images/801_20231020024004_img_20231020143945_darjeeling-tour-package-northeast-india.jpg'
// import PackagesCard from '../common/PackagesCard'

export default function DarjeelingTour() {
  return (
    <>
    <Header/>
        ...
        <div className="container px-0">
            <div className="nav_listing">
                <ul className='d-flex list-inline'>
                    ...
                    <li className='fw-bold px-1'> / Darjeeling</li>
                </ul>
            </div>
            <div className="row">
                <div>
                    <h1>Darjeeling Tour Packages</h1>
                    <p>Darjeeling Tour Packages</p>
                </div>
            </div>
